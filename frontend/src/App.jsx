...
function AdminApp({ onSignOut }) {
  ...
  const saveEmployee = (employee) => {
    setEmployees((current) => employee.id ? current.map((item) => item.id === employee.id ? employee : item) : [...current, { ...employee, id: Date.now() }])
      ...
      <div className="main-column">
        <header className="topbar">
          ...
          <div className="topbar-actions">
            <label className="search-field"><span className="search-mark">?</span><input type="search" placeholder="Search workspace" aria-label="Search workspace" /><kbd>/</kbd></label>
